...
let reloadBusy = false, reloadAgain = false, currentPage = 'dashboard', modalEditingPO = null, modalEditingShipment = null;
...
$('addPO').addEventListener('click',()=>showPO());$('addShip').addEventListener('click',()=>showShipment());
